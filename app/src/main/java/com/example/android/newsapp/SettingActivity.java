...
public class SettingActivity extends AppCompatActivity {
    ...
    public static class ArticlePreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference queryWord = findPreference(getString(R.string.settings_query_key));
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            if (preference instanceof ListPreference) {
                ...
                if (value.toString().isEmpty()) preference.setSummary(getString(R.string.settings_query_default));
